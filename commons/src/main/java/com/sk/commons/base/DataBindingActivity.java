 ...
 */
public abstract class DataBindingActivity<T extends BasePresenter, E extends BaseModel> extends AppCompatActivity {
     ...
     * @return
     */
    protected abstract void setContentView(Activity activity);
